      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <p className="text-lg  max-w-xl">
            I craft powerful and scalable applications where technology meets efficiency. Building exceptional digital solutions with Java, Spring Boot, and modern backend frameworks.
          </p>
